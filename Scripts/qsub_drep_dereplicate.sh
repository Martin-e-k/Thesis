...
#PBS -N qsub_drep_dereplicate
### Output files (comment out the next 2 lines to get the job name used instead)
#PBS -e $PBS_JOBID.qsub_drep_dereplicate.stderr
#PBS -o $PBS_JOBID.qsub_drep_dereplicate.stdout
...
# qsub -F '/home/projects/ku_00041/people/markri/data/drep/dereplicate' /home/projects/ku_00041/people/markri/scripts/qsub_drep_dereplicate.sh
...
dRep dereplicate "$outputDir" -g /home/projects/ku_00041/people/markri/data/vamb/vamb_output/bins/* -d
#dRep dereplicate "$outputDir" -g /home/projects/dtu_00009/data/chicken_data_TM/2_omgang/inStrain/combined_db_bins_refs/* -d --ignoreGenomeQuality
