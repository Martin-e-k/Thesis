...
#PBS -e $PBS_JOBID.megahit.stderr
#PBS -o $PBS_JOBID.megahit.stdout
###
...
#parallel --xapply "qsub -F '{1} {2}' /home/projects/ku_00041/people/markri/scripts/qsub_megahit.sh " :::: /home/projects/ku_00041/people/markri/lists/r1_all.list :::: /home/projects/ku_00041/people/markri/lists/r2_all.list
...
megahit -1 "$R1" -2 "$R1" -o /home/projects/ku_00041/people/markri/data/megahit/"$output_dir" --presets meta-large 
